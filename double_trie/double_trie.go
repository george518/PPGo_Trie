/************************************************************
** @Description: 双数组trie树
** @Author: george hao
** @Date:   2018-02-22 10:20
** @Last Modified by:  george hao
** @Last Modified time: 2018-02-22 10:20
*************************************************************/
package double_trie
...
func (da *dat) get(key []byte, from, pos int) *int {
	for ; pos < len(key); pos++ {
...
func (da *dat) follow(from int, label byte) int {
...
func (da *dat) popEnode(base int, label byte, from int) int {
	e := base ^ int(label)
	if base < 0 {
		e = da.findPlace()
	}
...
func (da *dat) findPlaces(child []byte) int {
	bi := da.BheadO
	if bi != 0 {
...
func (da *dat) pushBlock(bi int, head_out *int, empty bool) {
	b := &da.Blocks[bi]
	if empty {
...
func (da *dat) popBlock(bi int, head_in *int, last bool) {
	if last {
		*head_in = 0
	} else {
		b := &da.Blocks[bi]
...
func (da *dat) pushSibling(from, base int, label byte, hasChild bool) {
...
func (da *dat) popSibling(from, base int, label byte) {
	c := &da.Ninfos[from].Child
	for *c != label {
		c = &da.Ninfos[base^int(*c)].Sibling
	}
...
func (da *dat) resolve(from_n, base_n int, label_n byte) int {
...
func (da *dat) setChild(base int, c byte, label byte, flag bool) []byte {
...
func (da *dat) consult(base_n, base_p int, c_n, c_p byte) bool {
